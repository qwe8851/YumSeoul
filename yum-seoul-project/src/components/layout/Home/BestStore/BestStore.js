        ...
        <section>
            <div className={classes['best-store']}>
                ...
                <div className='main-content'>
                    {isError
                        ? <p className='error-text'>{errorMessage}<br /><br />이용에 불편을 드려 죄송합니다.<br />새로고침으로 데이터를 불러와 주세요.</p>
                        : storeResult
                    }
                </div>
            </div>
